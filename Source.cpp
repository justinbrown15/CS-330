...
int main()
{
	...
	// --------------------
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "My 3D Scene", NULL, NULL);
	if (window == NULL)
	{
	...
	//unsigned int planeDiffuseMap = loadTexture("images/blue.jpg");
	unsigned int planeDiffuseMap = loadTexture("images/mousepad2.jpg");
	unsigned int eggDiffuseMap = loadTexture("images/purple.jpg");
	unsigned int CylDiffuseMap = loadTexture("images/redt.png");
	unsigned int BallDiffuseMap = loadTexture("images/marble.jpg");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glBindTexture(GL_TEXTURE_2D, CylDiffuseMap);
		glBindVertexArray(VAO3);
		...
		static_meshes_3D::Cylinder C(0.3, 12, 2, true, true, true);
